...
-outjars ../AndroidSDKSample/Leanplum.jar

-libraryjars ../../Tools/android.jar
-libraryjars ../../Tools/android-support-v4.jar
-libraryjars ../../Tools/android-support-v7-appcompat.jar
-libraryjars ../../Tools/annotations.jar
-libraryjars "../AndroidSDK/libs/actionbarsherlock.jar"
-libraryjars "../AndroidSDK/build/intermediates/exploded-aar"
...
-keep class com.leanplum.LocationManagerImpl { *; }
...
# UNCOMMENT THESE LINES TO CREATE THE DEBUG VERSION OF OUR SDK
