...
public class ActionArgs {
  private static final String TAG = "Leanplum [ActionArgs]";
  ...
  public <T> ActionArgs with(String name, T defaultValue) {
    if (name == null) {
      Log.e(TAG, "with - Invalid name parameter provided.");
      return this;
    }
  ...
  public ActionArgs withColor(String name, int defaultValue) {
    if (name == null) {
      Log.e(TAG, "withColor - Invalid name parameter provided.");
      return this;
    }
   ...
   * @param name The name of the argument.
   * @param defaultFilename The path of the default file value.
   * Use null to indicate no default value.
   */
  public ActionArgs withFile(String name, String defaultFilename) {
    if (name == null) {
      Log.e(TAG, "withFile - Invalid name parameter provided.");
      return this;
    }
  ...
  /**
   * Adds an asset argument. Same as {@link ActionArgs#withFile} except that the filename
   * is relative to the assets directory.
   * @param name The name of the argument.
   * @param defaultFilename The path of the default file value relative to the assets directory.
   * Use null to indicate no default value.
   */
  public ActionArgs withAsset(String name, String defaultFilename) {
    if (name == null) {
      Log.e(TAG, "withAsset - Invalid name parameter provided.");
      return this;
    }
  ...
  public ActionArgs withAction(String name, String defaultValue) {
    if (name == null) {
      Log.e(TAG, "withAction - Invalid name parameter provided.");
      return this;
    }
