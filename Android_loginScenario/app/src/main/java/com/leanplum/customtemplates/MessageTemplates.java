...
public class MessageTemplates {
  static class Args {
    ...
    static final String ACCEPT_BUTTON_TEXT_2 = "Accept button2.Text";
    static final String ACCEPT_BUTTON_BACKGROUND_COLOR_2 = "Accept button2.Background color";
    static final String ACCEPT_BUTTON_TEXT_COLOR_2 = "Accept button2.Text color";
  ...
  public synchronized static void register(Context currentContext) {
    ...
    CenterPopupCustom.register(currentContext);
