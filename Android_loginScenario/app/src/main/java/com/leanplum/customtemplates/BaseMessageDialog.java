...
public class BaseMessageDialog extends Dialog {
  ...
  private RelativeLayout createContainerView(Activity context, boolean fullscreen) {
    ...
    if (!isWeb) {
      ...
      // FEDE adding this
      View button2 = createAcceptButton2(context);
      button2.setId(106);
      view.addView(button2, button2.getLayoutParams());
      ...
      // FEDE modified
      ((RelativeLayout.LayoutParams) message.getLayoutParams())
              .addRule(RelativeLayout.ABOVE, button2.getId());
  ...
  private TextView createAcceptButton(Context context) {
    ...
    // modifying this - it was CENTER_HORIZONTAL
    layoutParams.addRule(RelativeLayout.CENTER_HORIZONTAL, RelativeLayout.TRUE);
    layoutParams.setMargins(0, 0, 0, SizeUtil.dp50);
...
// FEDE - mofified
  private TextView createAcceptButton2(Context context) {
    TextView view = new TextView(context);
    RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    layoutParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
    ...
    view.setPadding(SizeUtil.dp20, SizeUtil.dp5, SizeUtil.dp20, SizeUtil.dp5);
    view.setLayoutParams(layoutParams);
    view.setText(options.getAcceptButtonText2());
    view.setTextColor(options.getAcceptButtonTextColor2());
    view.setTypeface(null, Typeface.BOLD);

    BitmapUtil.stateBackgroundDarkerByPercentage(view,
            options.getAcceptButtonBackgroundColor2(), 30);
