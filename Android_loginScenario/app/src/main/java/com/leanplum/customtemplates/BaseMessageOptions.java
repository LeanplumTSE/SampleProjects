...
abstract class BaseMessageOptions {
    ...
    public String getAcceptButtonText2() {
        return acceptButtonText2;
    }

    public void setAcceptButtonText2(String acceptButtonText2) {
        this.acceptButtonText2 = acceptButtonText2;
    }

    public void setAcceptButtonBackgroundColor2(int acceptButtonBackgroundColor2) {
        this.acceptButtonBackgroundColor2 = acceptButtonBackgroundColor2;
    }

    public void setAcceptButtonTextColor2(int acceptButtonTextColor2) {
        this.acceptButtonTextColor2 = acceptButtonTextColor2;
    }

    public int getAcceptButtonBackgroundColor2() {
        return acceptButtonBackgroundColor2;
    }

    public int getAcceptButtonTextColor2() {
        return acceptButtonTextColor2;
    }

    private String acceptButtonText2;
    private int acceptButtonBackgroundColor2;
    private int acceptButtonTextColor2;
    ...
    protected BaseMessageOptions(ActionContext context) {
        ...
        setAcceptButtonText2(context.stringNamed(Args.ACCEPT_BUTTON_TEXT_2));
        setAcceptButtonBackgroundColor2(context.numberNamed(Args.ACCEPT_BUTTON_BACKGROUND_COLOR_2).intValue());
        setAcceptButtonTextColor2(context.numberNamed(Args.ACCEPT_BUTTON_TEXT_COLOR_2).intValue());
    }
