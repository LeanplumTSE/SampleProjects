...
//        });
        ...
        NewsfeedChangedCallback mNewsfeedChangedCallback = new NewsfeedChangedCallback() {
            @Override
            public void newsfeedChanged() {
                Log.i("### ", "Newsfeed updated with A");
                ListAdapter updatedListAdapter = createListAdapter();
        ...
        Leanplum.newsfeed().addNewsfeedChangedHandler(mNewsfeedChangedCallback);


//        Leanplum.newsfeed().addChangedHandler(new InboxChangedCallback() {
//            @Override
//            public void inboxChanged() {
//                Log.i("### ", "Newsfeed updated with B");
//                ListAdapter updatedListAdapter = createListAdapter();
//                listView.setAdapter(updatedListAdapter);
//            }
//        });
