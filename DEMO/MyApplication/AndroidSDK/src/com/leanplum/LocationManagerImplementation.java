...
/**
 * Handles geofencing and sending user location.
 *
...
class LocationManagerImplementation implements
  ...
  private LocationAccuracyType lastLocationSentAccuracyType;
  ...
  enum LocationAccuracyType {
    ...
    LocationAccuracyType(int value) {
      this.value = value;
    }
  ...
  private LocationManagerImplementation() {
    ...
    lastLocationSentAccuracyType = LocationAccuracyType.IP;
  ...
  public void onLocationChanged(Location location) {
    ...
    LocationAccuracyType locationAccuracyType =
        location.getAccuracy() >= ACCURACY_THRESHOLD_GPS ?
            LocationAccuracyType.CELL : LocationAccuracyType.GPS;
   ...
   *
   * @param newLocationAccuracyType LocationAccuracyType of the new location.
   * @return boolean Whether it is needed to call setUserAttributes API for location update.
   */
  private boolean needToSendLocation(LocationAccuracyType newLocationAccuracyType) {
   ...
   * @param locationAccuracyType LocationAccuracyType of the location IP, CELL, or GPS
   */
  private void setUserAttributesForLocationUpdate(Location location,
    ...
    params.put(Constants.Keys.LOCATION_ACCURACY_TYPE, locationAccuracyType.name().toLowerCase());
    ...
    req.onResponse(new Request.ResponseCallback() {
      ...
      public void response(JSONObject response) {
        ...
        isSendingLocation = false;
        Log.d("setUserAttributes is successfully called");
      }
    });
    ...
    req.onError(new Request.ErrorCallback() {
      ...
      public void error(Exception e) {
        isSendingLocation = false;
        Log.e("setUserAttributes failed with error: " + e.getMessage());
      }
    });
