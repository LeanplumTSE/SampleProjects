...
import com.leanplum.internal.uieditor.LeanplumEditorMode;
import com.leanplum.internal.uieditor.LeanplumInterfaceEditor;
...
public class Socket {
  ...
  void previewUpdateRules(JSONArray arguments) {
    ...
    LeanplumInterfaceEditor.setMode(mode);
