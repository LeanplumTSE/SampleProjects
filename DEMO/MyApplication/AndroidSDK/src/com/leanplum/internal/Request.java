...
public class Request {
  ...
  public static long DEVELOPMENT_MAX_DELAY_MS = 5000;
  ...
  private static Map<String, Boolean> fileTransferStatus = new HashMap<>();
  ...
  private static Map<File, Long> fileUploadSize = new HashMap<>();
  private static Map<File, Double> fileUploadProgress = new HashMap<>();
