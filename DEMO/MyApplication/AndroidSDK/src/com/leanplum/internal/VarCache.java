...
public class VarCache {
   ...
   * synchronized.
   */
  public static final Map<String, Object> valuesFromClient = new HashMap<String, Object>();
  ...
  private static Map<String, Object> messageDiffs;
  ...
  public static void applyUpdateRuleDiffs(List<Map<String, Object>> updateRuleDiffs) {
  ...
  public static void downloadUpdateRulesImages() {
    for (Map value : VarCache.updateRuleDiffs) {
      List changes = (List) value.get("changes");
      for (Object change : changes) {
        String key = ((Map<String, String>) change).get("key");
        if (key != null && key.contains("image")) {
          String name = ((Map<String, String>) change).get("value");
          FileManager.maybeDownloadFile(true, name, null, new Runnable() {
            @Override
            public void run() {
            }
          });
