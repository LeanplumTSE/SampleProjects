...
public class Constants {
  ...
  public static String LEANPLUM_VERSION = "1.3.2";
  ...
  public static class Defaults {
    ...
    public static final String ACTION_METADATA_KEY = "__leanplum_action_metadata";
    ...
    public static final String PUSH_TOKEN_KEY = "__leanplum_push_token_%s-%s-%s";
    public static final String LOCAL_NOTIFICATION_KEY = "__leanplum_local_message_%s";
    public static final String NEWSFEED_KEY = "__leanplum_newsfeed";
  ...
  public static class Methods {
    ...
    public static final String DELETE_NEWSFEED_MESSAGE = "deleteNewsfeedMessage";
    public static final String DOWNLOAD_FILE = "downloadFile";
    public static final String GET_NEWSFEED_MESSAGES = "getNewsfeedMessages";
    public static final String GET_VARS = "getVars";
    public static final String HEARTBEAT = "heartbeat";
    public static final String LOG = "log";
    public static final String MARK_NEWSFEED_MESSAGE_AS_READ = "markNewsfeedMessageAsRead";
  ...
  public static class Params {
    ...
    public static final String NEWSFEED_MESSAGE_ID = "newsfeedMessageId";
    public static final String NEWSFEED_MESSAGES = "newsfeedMessages";
  ...
  public static class Keys {
    public static final String ACTION_METADATA = "actionMetadata";
    ...
    public static final String PUSH_MESSAGE_ACTION_NAME = "_lpa";
    ...
    public static final String SYNC_NEWSFEED = "syncNewsfeed";
  ...
  static final String HELD_BACK_EVENT_NAME = "Held Back";
  static final String HELD_BACK_MESSAGE_PREFIX = "__held_back__";

  public static class Values {
    public static final String DETECT = "(detect)";
    public static final String ACTION_PREFIX = "__action__";
